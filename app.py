...
with col1:
    ...
    if localidade_selecionada == "Todos":
        ...
        st.write("### Média de Instituições de Ensino Superior (Todas as localidades):")
...
with col2:
    st.write("### Gráfico de Linhas: Evolução no números de intituições de Ensino Superior")
...
with col3:
    st.write("### Comparação da Cidade com a Média Geral de intituições de Ensino Superior")
